...
namespace MohammadHosseinSadeghiCrudTest.Data
{
    ...
    //    new Movie { Id = 1, Title = "Avengers: Endgame",DurationInMinutes = 181, ReleaseDate = new DateTime(2019, 4, 26)   },
    //    new Movie { Id = 2, Title = "The Lion King",  DurationInMinutes     = 118, ReleaseDate = new DateTime(2019, 7, 19) },
    //    new Movie { Id = 3, Title = "Ip Man 4", ReleaseDate = new DateTime(2019, 12, 25) },
    //    new Movie { Id = 4, Title = "Gemini Man", DurationInMinutes = 116, ReleaseDate = new DateTime(2019, 11, 20) },
    //    new Movie { Id = 5, Title = "Downton Abbey", DurationInMinutes = 120, ReleaseDate = new DateTime(2020, 9, 20 )}
    //};
    //        var series = new Series[] {
    //    new Series { Id = 6 , Title = "The Fresh Prince of Bel-Air", NumberOfEpisodes = 148, ReleaseDate = new DateTime(1990, 9, 10) },
    //    new Series { Id = 7 , Title = "Downton Abbey", NumberOfEpisodes = 52, ReleaseDate = new DateTime(2010, 09, 26) },
    //    new Series { Id = 8 , Title = "Stranger Things", NumberOfEpisodes = 34 , ReleaseDate = new DateTime(2016, 7, 11) },
    //    new Series { Id = 9 , Title = "Kantaro: The Sweet Tooth Salaryman", NumberOfEpisodes = 12, ReleaseDate = new DateTime(2017,7, 14) },
    //    new Series { Id = 10, Title = "The Walking Dead", NumberOfEpisodes = 177 , ReleaseDate = new DateTime(2010, 10, 31) }
    //};
    ...
    //        modelBuilder.Entity<Rating>().HasData(ratings);
            ...
            //create  indexes
            modelBuilder.Entity<Domain.Entities.Customers.Customer>()
  .HasIndex(c => new { c.FirstName, c.LastName , c.DateOfBirth }).IsUnique();
       ...
       .IsUnique();
        ...
        public DbSet<MohammadHosseinSadeghiCrudTest.Models.CustomerModel> CustomerModel { get; set; }
